...
# import system3
import module.Pallet.system3 as system3
import math
import copy
import time
        ...
        if self.connect_read.poll():
            ...
            if conn_data:
                for i, conn_data_li in enumerate(conn_data):
                    ...
                    if task_name=="GetModuleList" and sub_method=="SEND":
                        del conn_data[i]
                        self.connect_write.send(conn_data)
    ...
    def request_exert_module(self, event, module):
        ...
        self.convert_data(
            ...
            [
                ...
                "center",
                module,
                [] if module!="exit" else [self.x+self.root_x, self.y+self.root_y]
            ]
        )
        self.connect_write.send(conn_data)
...
def hello(conn_r, conn_w):
    ...
    for j, cl in enumerate(["#FFFFFF"]+color1):
        ...
        if j>0:
            Pallet.set_button_event((cl_rgb[0], cl_rgb[1], cl_rgb[2]), Pallet.request_exert_module, ("Left", "Release"), partmodule[j-1])
