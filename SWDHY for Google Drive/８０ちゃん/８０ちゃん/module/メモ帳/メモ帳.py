...
def hello(conn_r, conn_w) :
    ...
    if os.path.exists(PATH+"/memo1.txt")== True:
        pass
    else:
        f = pathlib.Path(PATH+'/memo1.txt')
        f.touch()

    if os.path.exists(PATH+"/memo2.txt")== True:
        pass
    else:
        f = pathlib.Path(PATH+'/memo2.txt')
        f.touch()

    if os.path.exists(PATH+"/memo3.txt")== True:
        pass
    else:
        f = pathlib.Path(PATH+'/memo3.txt')
        f.touch()

    if os.path.exists(PATH+"/memo4.txt")== True:
        pass
    else:
        f = pathlib.Path(PATH+'/memo4.txt')
        f.touch()

    if os.path.exists(PATH+"/memo5.txt")== True:
        pass
    else:
        f = pathlib.Path(PATH+'/memo5.txt')
        f.touch()
    ...
    text1.grid(row=1,column=1,columnspan=4,ipadx=4,ipady=10)
    for line in open(PATH+"/memo1.txt",encoding="utf-8_sig"):
    ...
    text2.grid(row=1,column=1,columnspan=4,ipadx=4,ipady=10)
    for line in open(PATH+"/memo2.txt",encoding="utf-8_sig"):
        text2.insert(tk.END,line)
    text2.insert(tk.END, '')
        #スクロールバーの作成
    yscroll2 = tk.Scrollbar(frame2, orient=tk.VERTICAL, command=text2.yview)
    yscroll2.grid(row=1, column=5, sticky=tk.N+tk.S)
        #動きをスクロールバーに反映
    ...
    text3.grid(row=1,column=1,columnspan=4,ipadx=4,ipady=10)
    for line in open(PATH+"/memo3.txt",encoding="utf-8_sig"):
    ...
    text4.grid(row=1,column=1,columnspan=4,ipadx=4,ipady=10)
    for line in open(PATH+"/memo4.txt",encoding="utf-8_sig"):
        text4.insert(tk.END,line)
    text4.insert(tk.END, '')
        #スクロールバーの作成
    yscroll4 = tk.Scrollbar(frame4, orient=tk.VERTICAL, command=text4.yview)
    yscroll4.grid(row=1, column=5, sticky=tk.N+tk.S)
        #動きをスクロールバーに反映
    ...
    text5.grid(row=1,column=1,columnspan=4,ipadx=4,ipady=10)
    for line in open(PATH+"/memo5.txt",encoding="utf-8_sig"):
        text5.insert(tk.END,line)
    text5.insert(tk.END, '')
        #スクロールバーの作成
    yscroll5 = tk.Scrollbar(frame5, orient=tk.VERTICAL, command=text5.yview)
    yscroll5.grid(row=1, column=5, sticky=tk.N+tk.S)
        #動きをスクロールバーに反映
    ...
    def save1_click():
        ...
        with open(PATH+"/memo1.txt", mode="w", encoding="utf-8_sig") as f:
            f.write(txt1)
    ...
    def reload1_click():
        ...
        for line in open(PATH+"/memo1.txt",encoding="utf-8_sig"):
            text1.insert(tk.END,line)
        text1.insert(tk.END, '')
    reload1Button = tk.Button(frame1,text='読み込み',command=reload1_click)
    reload1Button.grid(row=2,column=3)
    def destroy1_click():
        text1.delete(1.0,tk.END)
        with open(PATH+"/memo1.txt", mode="w", encoding="utf-8_sig") as f:
            f.write("")
    destroy1Button = tk.Button(frame1,text='削除して保存',bg='orangered',command=destroy1_click)
    destroy1Button.grid(row=2,column=4)

    def save2_click():
        txt2=text2.get(1.0,tk.END)
        with open(PATH+"/memo2.txt", mode="w", encoding="utf-8_sig") as f:
            f.write(txt2)
    ...
    def reload2_click():
        ...
        for line in open(PATH+"/memo2.txt",encoding="utf-8_sig"):
            text2.insert(tk.END,line)
        text2.insert(tk.END, '')
    reload2Button = tk.Button(frame2,text='読み込み',command=reload2_click)
    reload2Button.grid(row=2,column=3)
    def destroy2_click():
        text2.delete(1.0,tk.END)
        with open(PATH+"/memo2.txt", mode="w", encoding="utf-8_sig") as f:
            f.write("")
    destroy2Button = tk.Button(frame2,text='削除して保存',bg='orangered',command=destroy2_click)
    destroy2Button.grid(row=2,column=4)

    def save3_click():
        txt3=text3.get(1.0,tk.END)
        with open(PATH+"/memo3.txt", mode="w", encoding="utf-8_sig") as f:
            f.write(txt3)
    ...
    def reload3_click():
        ...
        for line in open(PATH+"/memo3.txt",encoding="utf-8_sig"):
            text3.insert(tk.END,line)
        text3.insert(tk.END, '')
    reload3Button = tk.Button(frame3,text='読み込み',command=reload3_click)
    reload3Button.grid(row=2,column=3)
    def destroy3_click():
        text3.delete(1.0,tk.END)
        with open(PATH+"/memo3.txt", mode="w", encoding="utf-8_sig") as f:
            f.write("")
    destroy3Button = tk.Button(frame3,text='削除して保存',bg='orangered',command=destroy3_click)
    destroy3Button.grid(row=2,column=4)

    def save4_click():
        txt4=text4.get(1.0,tk.END)
        with open(PATH+"/memo4.txt", mode="w", encoding="utf-8_sig") as f:
            f.write(txt4)
    ...
    def reload4_click():
        ...
        for line in open(PATH+"/memo4.txt",encoding="utf-8_sig"):
            text4.insert(tk.END,line)
        text4.insert(tk.END, '')
    reload4Button = tk.Button(frame4,text='読み込み',command=reload4_click)
    reload4Button.grid(row=2,column=3)
    def destroy4_click():
        text4.delete(1.0,tk.END)
        with open(PATH+"/memo4.txt", mode="w", encoding="utf-8_sig") as f:
            f.write("")
    destroy4Button = tk.Button(frame4,text='削除して保存',bg='orangered',command=destroy4_click)
    destroy4Button.grid(row=2,column=4)

    def save5_click():
        txt5=text5.get(1.0,tk.END)
        with open(PATH+"/memo5.txt", mode="w", encoding="utf-8_sig") as f:
            f.write(txt5)        
    ...
    def destroy5_click():
        ...
        with open(PATH+"/memo5.txt", mode="w", encoding="utf-8_sig") as f:
            f.write("")
    destroy5Button = tk.Button(frame5,text='削除して保存',bg='orangered',command=destroy5_click)
    destroy5Button.grid(row=2,column=4)
